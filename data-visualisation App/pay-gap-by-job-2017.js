function PayGapByJob2017() {
  ...
  this.draw = function () {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      fill(
        map(
          dist( //Longer the distance redder the ellipse. Less equality.
        ...
        map(
          dist( //Shorter the distance greener the ellipse. More equality.
            map(propFemale[i], propFemaleMin, propFemaleMax, this.pad, width - this.pad),
            map(payGap[i], payGapMin, payGapMax, height - this.pad, this.pad),
            width / 2,
            height / 2),
        ...
        0, //Blue set at 0.
        215); //Hue set to 215 to have some transparency
